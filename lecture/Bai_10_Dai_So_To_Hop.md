...
**Bài 2:** Có bao nhiêu số có 4 chữ số khác nhau được tạo từ các chữ số 1, 2, 3, 4, 5, 6?
...
| Khi nào dùng | Sắp xếp, xếp hàng | Chọn, tập hợp |
...
**Bài 1:** Một lớp có 30 học sinh. Chọn 5 học sinh để tham gia hoạt động ngoại khóa. Hỏi có bao nhiêu cách chọn?
...
| Chọn (không thứ tự) | C(n,r) = n!/(r!(n-r)!) | Chọn 3 người từ 5 người |
...
**Ví dụ 2:** "Có bao nhiêu cách **xếp** 3 học sinh vào 3 vị trí: lớp trưởng, lớp phó, thư ký?"
- Từ khóa: "xếp", "vị trí"
- **Đáp án:** P(10, 3) = 720
...
Có bao nhiêu mật khẩu dài 6 ký tự, sử dụng 26 chữ cái (không phân biệt hoa thường), trong đó:
